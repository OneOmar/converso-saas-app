            ...
            <TableRow key={id}>
              <TableCell>
                <Link href={`/companions/${id}`} className="flex items-center gap-2">
                  ...
                  >
                    <Image src={`/icons/${subject}.svg`} alt="" width={35} height={35} />
                  </div>
              ...
              <TableCell>
                ...
                <div
                  ...
                  style={{ backgroundColor: getSubjectColor(subject) }}
                >
                  <Image src={`/icons/${subject}.svg`} alt="" width={18} height={18} />
                </div>
              </TableCell>
              ...
              <TableCell>
                <div className="flex items-center justify-center gap-2 w-full">
                  ...
                  <Image src="/icons/clock.svg" alt="" width={14} height={14} className="md:hidden" />
                </div>
              </TableCell>
            </TableRow>
          ))}
